...
- **Bluetooth AVRCP 1.4 Support** ⚠️ **WIP** – Forces AVRCP 1.4 advertisement across all BT stack layers (daemon, ODEX, JNI library, core library); all binaries flashed, `cardinality:0` open
