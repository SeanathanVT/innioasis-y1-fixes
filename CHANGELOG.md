...
- **Four more silent `sudo cp/install` failure sites in `apply.bash` now checked.** All would have produced a "successfully" flashed system.img missing the targeted change without the user knowing:
